...
var createMentionPlugin = function createMentionPlugin() {
  ...
  var _config$newSuggestion = config.newSuggestionText;
  var newSuggestionText = _config$newSuggestion === undefined ? 'Add new' : _config$newSuggestion;
  ...
  var mentionSearchProps = {
    ...
    newSuggestionText: newSuggestionText
  };
  return {
