...
var MentionSuggestions = function (_Component) {
  ...
  function MentionSuggestions() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(MentionSuggestions)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {
      ...
      if (_this.props.suggestions.size > 0) {
        var newIndex = _this.state.focusedOptionIndex - 1;
        _this.onMentionFocus(Math.max(newIndex, -1));
      }
    ...
    }, _this.onEmptyMentionSelect = function () {
      _this.closeDropdown();

      var blockMap = _this.props.store.getEditorState().getCurrentContent().getBlockMap();

      var newTagText = '';

      blockMap.forEach(function (b) {
        var lastEntityIndex = -1;

        b.findEntityRanges(function (character) {
      ...
      if (newTagText) {
        var newEditorState = (0, _addMention2.default)(_this.props.store.getEditorState(), (0, _immutable.fromJS)({
          name: newTagText,
          link: ''
  ...
  _createClass(MentionSuggestions, [{
    ...
    value: function render() {
      ...
      var newSuggestionText = _props.newSuggestionText;
      ...
      var other = _objectWithoutProperties(_props, ['theme', 'newSuggestionText', 'onSearchChange', 'suggestions', 'ariaProps', 'callbacks', 'store', 'entityMutability', 'positionSuggestions']);

      var emptyMention = (0, _immutable.fromJS)({
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Entry2.default, {
          ...
          onMentionFocus: function onMentionFocus() {
            return _this2.onMentionFocus(-1);
          },
